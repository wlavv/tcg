                ...
                foreach ($f['form']['input'] as $j => $input) {
                    if (isset($input['lang'])) {
                        foreach ($languages as $lang) {
                            $fields_values[$input['name']][$lang['id_lang']] = isset($obj[$input['name'].'_'.$lang['id_lang']]) ? stripslashes($obj[$input['name'].'_'.$lang['id_lang']]) : $input['default'];
                        }
                    } else {
                        if (isset($obj[trim($input['name'])])) {
                            ...
                            $fields_values[$input['name']] = stripslashes($value);
                        } else {
