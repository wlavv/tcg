                                        ...
                                        ;" title="{l s='Delete' mod='leoslideshow'}" class="delete">
                                                    ...
                                                    {if $languages|count > 1}
                                                        {foreach from=$languages item=language}
                                                            ...
                                                            <li><a class="group-preview" target="_blank" href="{$link->getModuleLink('leoslideshow','preview', $arrayParam, null, $language.id_lang|intval)}">
                                                                <i class="icon-eye-open"></i> {l s='Preview For' mod='leoslideshow'} {$language.name|escape:'html':'UTF-8'}
                                                            </a></li>
                                                        {/foreach}
                                                    {else}
                                                        <li><a class="group-preview" target="_blank" href="{$previewLink|escape:'html':'UTF-8'}&id_group={$group.id_leoslideshow_groups|intval}">
                                                            <i class="icon-eye-open"></i> {l s='Preview Group' mod='leoslideshow'}
                                                        </a></li>
                                                    {/if}
                                                    <li><a class="" target="_blank" href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&configure=leoslideshow&&exportGroup=1&id_group={$group.id_leoslideshow_groups|intval}">
                                                        <i class="icon-archive"></i> {l s='Export Group and sliders' mod='leoslideshow'}
                                                    </a></li>
                                                    <li><a class="" href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&configure=leoslideshow&editgroup=1&copylang=1&id_group={$group.id_leoslideshow_groups|intval}">
