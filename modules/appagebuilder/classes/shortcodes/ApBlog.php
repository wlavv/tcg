...
//            $list = array();
            ...
            if (Tools::getIsset('chk_cat')) {
                $chk_cat = Tools::getValue('chk_cat');
                $arr_key = explode(',', $chk_cat);
            ...
            $data_category = '';
            $data_category = Tools::htmlentitiesDecodeUTF8($module->getTreeForApPageBuilder($selected_categories));
            $inputs = array(
                array(
                    'type' => 'text',
                    'name' => 'title',
...
//            }
            ...
            $where = ' WHERE randkey IN ('.$randkey_cat.')';
