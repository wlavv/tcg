...
class ApBlockCarousel extends ApShortCodeBase
{
  ...
  responsive: [
      ...
      settings: {
        ...
        slidesToScroll: 1
            ...
            array(
                ...
                'default' => '',
                'class' => 'item-add-slide ignore-lang',
                'form_group_class' => 'apfullslider-row sub-title-slide',
            ),
            array(
                'type' => 'text',
                'name' => 'temp_link',
    ...
    public function addConfigList($values)
    {
        ...
        $arr = explode('|', $total);
        $inputs = array('tit', 'sub_tit', 'image_link' ,'img', 'link', 'descript');
        ...
        $list_slider = Context::getContext()->smarty->fetch(apPageHelper::getShortcodeTemplatePath('ApBlockCarousel.tpl'));
    ...
    public function prepareFontContent($assign, $module = null)
    {
        ...
        foreach ($list as $item) {
            if ($item) {
                ...
                $slider['sub_title'] = isset($assign['formAtts']['sub_tit_'.$temp]) ? $assign['formAtts']['sub_tit_'.$temp] : '';
