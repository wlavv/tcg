                            ...
                            <div class="block-carousel-image-container image">
                                ...
                                {if (isset($slider.image) && !empty($slider.image)) || (isset($slider.image_link) && !empty($slider.image_link))}
                                    {if isset($formAtts) && isset($formAtts.lazyload) && $formAtts.lazyload}
                                        ...
                                        <img class="img-fluid lazyOwl" src="" data-src="{if $slider.image}{$slider.image}{else}{$slider.image_link}{/if}{*full link can not escape*}" alt="{if isset($slider.title)}{$slider.title|escape:'html':'UTF-8'}{/if}" loading="lazy"/>
                                    {else}
                                        <img class="img-fluid{if $aplazyload} lazy{/if}" {if $aplazyload} data-src{else}src{/if}="{if $slider.image}{$slider.image}{else}{$slider.image_link}{/if}{*full link can not escape*}" alt="{if isset($slider.title)}{$slider.title|escape:'html':'UTF-8'}{/if}" loading="lazy"/>
                                    {/if}
                                {/if}
