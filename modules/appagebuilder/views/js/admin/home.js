...
//                .find( ".waction-drag" ).addClass( $globalthis.classWidgetHeader );    
        ...
        this.setButtonAction = function () {
            ...
            $(document).on("click", ".btn-edit", function () {
                ...
                if (type.indexOf("Carousel") != -1 || type == 'ApBlog' || type == 'ApInstagram') {
                    var data_miss = ['scrollperpage', 'autoheight', 'mousedrag'];
                    for(var i=0; i<data_miss.length; i++){
                        if (data.indexOf(data_miss[i]) == -1) {
                            data += (data ? "&" : "") + data_miss[i] + "=0";
                        }
                    }
                }
                $("#txt-search").hide();
...
//                console.log(cla + '--' + valueColToNum + 'claa' + cla);
            ...
            $(document).on("click", "#pagination_imagemanager a", function (e) {
                e.preventDefault();
                var link = $(this);
                $.ajax({
                    url: $(link).attr("href"),
...
//                                    $("#ap_loading").hide();
        ...
        this.setFormAction = function () {
            ...
            $("#configuration_form .col-lg-8 .translatable-field .col-lg-2").each(function(){
                $(this).removeClass('col-lg-2').addClass('col-lg-3');
            })
        ...
        this.saveWidget = function (type) {
            ...
            if (widgetType.indexOf('ApSub') == 0) {
                ...
                Object.keys($globalthis.languages).forEach(function (key) {
                    ...
                    tmpObjectForm["sub_title_" + $globalthis.languages[key]] = ObjectForm["sub_title_" + $globalthis.languages[key]];
                });
            ...
            if (widgetType == "ApTabs" || widgetType == "ApAjaxTabs") {
