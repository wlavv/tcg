        ...
        if ($context->customer->isLogged()) {
            ...
            if ($action == 'get-wishlist-info') {
                ...
                if (!count($errors)) {
                    ...
                    if (isset($wishlist_product['nbProducts']) && $wishlist_product['nbProducts'] && $wishlist_product['nbProducts'] > 0) {
        ...
        if ($this->context->customer->isLogged()) {
            ...
            if (count($wishlists)>0) {
                foreach ($wishlists as $key => $wishlists_val) {
                    ...
                    $wishlists[$key]['number_product'] = isset($wishlist_product['nbProducts']) ? $wishlist_product['nbProducts'] : 0;
                }
            }
            $this->context->smarty->assign(array(
                'wishlists' => $wishlists,
