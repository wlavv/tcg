						...
						{foreach from=$criterions item='criterion'}
							<li>
								...
								<div class="star_content">
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_review_criterion|round}]" value="1"{if $defaultReview == 1} checked="checked"{/if} />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_review_criterion|round}]" value="2"{if $defaultReview == 2} checked="checked"{/if} />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_review_criterion|round}]" value="3"{if $defaultReview == 3} checked="checked"{/if} />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_review_criterion|round}]" value="4"{if $defaultReview == 4} checked="checked"{/if} />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_review_criterion|round}]" value="5"{if $defaultReview == 5} checked="checked"{/if} />
								</div>
