...
class __TwigTemplate_9707cf13ac25acf0a52a067ae3ec84d4 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "view_options", [], "any", false, true, false, 26), "display_name", [], "any", true, true, false, 26)) {
            // line 27
            echo "    ";
            $context["displayName"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 27, $this->source); })()), "view_options", [], "any", false, false, false, 27), "display_name", [], "any", false, false, false, 27);
        }
        // line 29
        echo "
...
";
    ...
    public function block_grid_panel_header($context, array $blocks = [])
    {
        ...
        // line 32
        echo "    ";
        if (( !((isset($context["displayName"]) || array_key_exists("displayName", $context) ? $context["displayName"] : (function () { throw new RuntimeError('Variable "displayName" does not exist.', 32, $this->source); })()) === false) || (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 32, $this->source); })()), "actions", [], "any", false, false, false, 32), "grid", [], "any", false, false, false, 32)) > 0))) {
            // line 33
            echo "    <div class=\"card-header js-grid-header\">
      ";
            // line 34
            if ( !((isset($context["displayName"]) || array_key_exists("displayName", $context) ? $context["displayName"] : (function () { throw new RuntimeError('Variable "displayName" does not exist.', 34, $this->source); })()) === false)) {
                // line 35
                echo "        <h3 class=\"d-inline-block card-header-title\">
          ";
                // line 36
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 36, $this->source); })()), "name", [], "any", false, false, false, 36), "html", null, true);
                echo " (";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 36, $this->source); })()), "data", [], "any", false, false, false, 36), "records_total", [], "any", false, false, false, 36), "html", null, true);
                echo ")
        </h3>
      ";
            }
    ...
    public function block_grid_actions_block($context, array $blocks = [])
    {
        ...
        echo "        <div class=\"d-inline-block float-right\">
          ";
        // line 41
        echo twig_include($this->env, $context, "@PrestaShop/Admin/Common/Grid/Blocks/grid_actions.html.twig", ["grid" => (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 41, $this->source); })())]);
        echo "
        </div>
      ";
  ...
  ";
    ...
    public function block_grid_view_block($context, array $blocks = [])
    {
        ...
        // line 51
        echo "        ";
        echo twig_include($this->env, $context, "@PrestaShop/Admin/Common/Grid/grid.html.twig", ["grid" => (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 51, $this->source); })())]);
        echo "
      ";
    ...
    {
        return array (  229 => 59,  211 => 56,  198 => 51,  188 => 50,  177 => 53,  175 => 50,  172 => 49,  162 => 48,  149 => 41,  146 => 40,  136 => 39,  126 => 46,  122 => 44,  119 => 39,  111 => 36,  108 => 35,  106 => 34,  103 => 33,  100 => 32,  90 => 31,  80 => 59,  76 => 57,  74 => 56,  71 => 55,  69 => 48,  66 => 47,  64 => 31,  60 => 30,  57 => 29,  53 => 27,  51 => 26,  49 => 25,);
    }
...
", "@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "/home/playfunc/tcg/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/grid_panel.html.twig");
    }
}
