 ...
 */
class EmployeeSession extends \PrestaShopBundle\Entity\Employee\EmployeeSession implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PrestaShopBundle\\Entity\\Employee\\EmployeeSession' . "\0" . 'id', '' . "\0" . 'PrestaShopBundle\\Entity\\Employee\\EmployeeSession' . "\0" . 'employee', '' . "\0" . 'PrestaShopBundle\\Entity\\Employee\\EmployeeSession' . "\0" . 'token', '' . "\0" . 'PrestaShopBundle\\Entity\\Employee\\EmployeeSession' . "\0" . 'dateAdd', '' . "\0" . 'PrestaShopBundle\\Entity\\Employee\\EmployeeSession' . "\0" . 'dateUpd'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeSession $proxy) {
