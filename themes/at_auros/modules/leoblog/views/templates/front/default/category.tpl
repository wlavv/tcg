		...
		<div id="blog-category" class="blogs-container">
			...
			<div class="inner">
				...
				{if count($leading_blogs)+count($secondary_blogs)}
					<h3 class="section-title blog-lastest-title">{l s='Recent blog posts' d='Shop.Theme.Global'}</h3>
					...
					<div class="leading-blog">  
						{foreach from=$leading_blogs item=blog name=leading_blog}
							...
							{if ($smarty.foreach.leading_blog.iteration%$listing_leading_column==1)&&$listing_leading_column>1}
								<div class="row">
							{/if}
							<div class="{if $listing_leading_column<=1}no{/if}col-md-{floor(12/$listing_leading_column|escape:'html':'UTF-8')} col-sm-12 col-xs-12 col-sp-12">
					...
					<div class="secondary-blog">
						...
						{foreach from=$secondary_blogs item=blog name=secondary_blog}
							...
							<div class="{if $listing_secondary_column<=1}no{/if}col-md-{floor(12/$listing_secondary_column|escape:'html':'UTF-8')} col-sm-6 col-xs-12 col-sp-12">
								{include file="module:leoblog/views/templates/front/default/_listing_blog.tpl"}
							</div>	
