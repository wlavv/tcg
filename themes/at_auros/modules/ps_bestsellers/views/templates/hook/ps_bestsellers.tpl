...
<section class="bestseller-products clearfix block">
  	<h2 class="h1 products-section-title title_block text-uppercase">
  	...
  	<div class="block_content">
  		...
  		<a class="all-product-link float-xs-left float-md-right btn btn-outline" href="{$allBestSellers}">
